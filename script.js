    ...
    let FORECAST_API_URL = `https://api.openweathermap.org/data/2.5/forecast/?lat=${lat}&lon=${lon}&appid=${api_key}`,
     ...
     fetch(AIR_POLLUTION_API_URL).then(res => res.json()).then(data => {
        ...
        fetch(WEATHER_API_URL).then(res => res.json()).then(data =>{
            ...
            currentWeatherCard.innerHTML = `
             <div class="current-weather">
                                <div class="details">
                                    ...
                                    <p>Now</p>
                                    <h2>${(data.main.temp - 273.15).toFixed(2)}___&deg;C</h2>
                            ...
                            <div class="card-footer">
                                <p><i class="fa-solid fa-calender"></i>${days[date.getDay()]},${date.getDate()}, ${months[date.getMonth()]} ${date.getFullYear()}</p>
            ...
            //                         <div class="item">
            //                             <div class="icon">
            //                                 <i class="fa-solid fa-sun-plant-wilt fa-3x"></i>
            //                             </div>
            //                             <div>
            //                                 <p>sunset</p>
            //                                 <h2>${sSetTime}</h2>
        ...
        .then(res => res.json())  // Corrected arrow function syntax
        .then(data => {
